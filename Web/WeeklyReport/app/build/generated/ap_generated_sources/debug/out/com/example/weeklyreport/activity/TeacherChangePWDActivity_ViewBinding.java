...
public class TeacherChangePWDActivity_ViewBinding implements Unbinder {
  private TeacherChangePWDActivity target;
  ...
  @UiThread
  public TeacherChangePWDActivity_ViewBinding(TeacherChangePWDActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public TeacherChangePWDActivity_ViewBinding(final TeacherChangePWDActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    TeacherChangePWDActivity target = this.target;
